...
int main(void) {
  static const int64_t code[] = { 11, 2, 21, 1, 10, 22, 1, 20, 22, 3, 0, 2, 0, 1, 30, 22, 3, 0, 1, 0, 3, 1, 1, 0, 3, 2, 2, 2, 2, 0, 23, 8, 12, 53, 2, 1, 2, 0, 2, 2, 24, 4, 3, 1, 2, 2, 1, 1, 4, 3, 2, 11, 26, 2, 1, 17, 1, 0, 13 };
