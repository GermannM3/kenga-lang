...
| ◐ | **Prophet-LM / Z-LM 93M** (скачать, подключить в LM Studio / Cursor): Z-факторизованные декодеры в форме Llama → GGUF; претрейн на 1660 идёт, SFT + оракул-eval автоматом — `docs/PROPHETS.md` §6–7 |
